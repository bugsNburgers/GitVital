...
export async function insertRepoMetrics(
  ...
  await dbQuery(
    ...
    [
      ...
      pr ? pr.avgMergeHrs ?? null : null,
      pr ? pr.medianMergeHrs ?? null : null,
      pr ? pr.p90MergeHrs ?? null : null,
      ...
      act ? act.commitsLast30Days ?? null : null,
      pr ? pr.totalPRs ?? null : null,
      iss ? iss.totalIssueCount ?? null : null,
